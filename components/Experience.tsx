  ...
  return (
    <div className='px-4 md:px-8 py-8 mt-5 relative' id='experience'>
        ...
        <div className='mt-8 grid grid-cols-1 xl:grid-cols-8 gap-4'>
            <div className='col-sapn-1 xl:col-span-4 p-4 w-full border-[1] border-black rounded-md'>
            ...
            <div className='col-sapn-1 xl:col-span-2 p-4 w-full border-[1] border-black rounded-md'>
